...
const q=buildContextMsg('💦 𝐒𝐏𝐔𝐓𝐀')

if(!target)return conn.sendMessage(chat,{
text:`*⚠️ 𝐃𝐞𝐯𝐢 𝐦𝐞𝐧𝐳𝐢𝐨𝐧𝐚𝐫𝐞 𝐪𝐮𝐚𝐥𝐜𝐮𝐧𝐨 𝐨 𝐫𝐢𝐬𝐩𝐨𝐧𝐝𝐞𝐫𝐞 𝐚 𝐮𝐧 𝐦𝐞𝐬𝐬𝐚𝐠𝐠𝐢𝐨 𝐩𝐞𝐫 𝐬𝐩𝐮𝐭𝐚𝐫𝐠𝐥𝐢 💦*
...
text:`*💦💦 ${tag(sender)} 𝐬𝐢 è 𝐬𝐩𝐮𝐭𝐚𝐭𝐨 𝐝𝐚 𝐬𝐨𝐥𝐨 💦*`,
...
handler.help=['sputa @user']
handler.tags=['fun']
handler.command=['sputa','sputo']
handler.group=true
